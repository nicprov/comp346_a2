...
public class Network extends Thread {
    ...
    private static Semaphore semaphoreInput = new Semaphore(1); /* Semaphore for Input Buffer */
    private static Semaphore semaphoreOutput = new Semaphore(1); /* Semaphore for Output Buffer */
